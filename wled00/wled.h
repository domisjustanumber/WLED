...
#define VERSION 2309022                // WLEDSR specific version
#define SR_VERSION_NAME "0.13.4-dev.1" // WLEDSR version name --> some files need manual updating: package.json, package-lock.json, improv.cpp
